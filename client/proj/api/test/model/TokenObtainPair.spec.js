...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.TokenObtainPair();
  });
  ...
  describe('TokenObtainPair', function() {
    it('should create an instance of TokenObtainPair', function() {
      // uncomment below and update the code to test TokenObtainPair
      //var instance = new OpenapiJsClient.TokenObtainPair();
      //expect(instance).to.be.a(OpenapiJsClient.TokenObtainPair);
    });
